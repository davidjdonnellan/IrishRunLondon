...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/CfhVGqa5Gr)
...
```sh
npx nx serve IrishRunLondon
```

To create a production bundle:

```sh
npx nx build IrishRunLondon
```

To see all available targets to run for a project, run:

```sh
npx nx show project IrishRunLondon
```
